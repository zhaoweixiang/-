$(function() {
	...
	$(function() {
		...
		<ul class="write"  id="keyboard" style="font-size:20px;">\
				...
				<li class="symbol"><span class="off">京</span></li>\
		...
		function b() {
			...
			$('#keyboard li').click(function() {				
				if($(this).hasClass('delete')) {
					...
					$(passwords.elements[index-- % 8]).val('');
				...
				if($(this).hasClass('symbol') || $(this).hasClass('tab')) {
					character = $(this).text();
					var index = $("#password input.curr").index();
					$(passwords.elements[index++ % 8]).val(character);
